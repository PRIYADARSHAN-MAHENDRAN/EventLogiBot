...
# ROLE_ID = (os.environ['ROLE_ID1']) #"1335290367347658762"
# DISCORD_WEBHOOK = (os.environ['DISCORD_WEBHOOK1']) #'https://discord.com/api/webhooks/1349764291859054623/WCmkpgMVX_MkVlpNyBnC_2fycbgDnUNdzMTmZhCdTASythWRXm_oa0UuF1U8Y4SBIYWg'
SHEET_ID = (os.environ['SHEET_ID1']) #'1xcTUTFmwirTCIAseDtgr0ev7cHJq8FAuGI7wHDa_yMg'

ROLE_ID = (os.environ['ROLE_ID2']) #"1356018983496843294"  # Replace with your actual Discord role ID
DISCORD_WEBHOOK = (os.environ['DISCORD_WEBHOOK2']) #'https://discord.com/api/webhooks/1358492482580779119/o4-NQuKr1zsUb9rUZsB_EnlYNiZwb_N8uXNfxfIRiGsdR8kh4CoKliIlSb8qot-F0HHO'
# SHEET_ID = (os.environ['SHEET_ID2']) #'1jTadn8TtRP4ip5ayN-UClntNmKDTGY70wdPgo7I7lRY'
